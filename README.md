...
## Prerequisites
1. at least JDK 8 (for Java 11, just set the property `java.version` to `11` to for example use the `var` keyword)
1. recent Maven (tested with 3.6.3)
1. Netbeans >= 8.2 (`nbactions.xml` tested with 8.2, 11.3 and 12.0)
