...
This is done with the `maven-skip-execution-profile-extension` that automatically creates the profiles needed for skipping certain plugins actions.
...
- Run Maven
  ...
  - **[Static Code Analysis]** `spotbugs:check`, `checkstyle:check`, `pmd:cpd-check` abd `arch-unit:arch-test`
